        ...
        <main className="bg-white">
            <aside className="mx-auto max-w-4xl px-6 py-14 text-left text-gray-800 text-charcoal-100">
                ...
                <header className="mt-24 mb-8">
                    <h1 className="text-3xl font-normal tracking-tight">Terms and Conditions</h1>
                ...
                <section className="mt-12 space-y-8">
                    ...
                    <div>
                        ...
                        <p className="mt-2">You agree not to misuse the Service, including (but not limited to):</p>
                        <ul className="mt-3 list-disc space-y-1 pl-5">
                    ...
                    <div>
                        ...
                        <p className="mt-2">
                            ...
                            by contacting us at{" "}
                            <a href="mailto:billing@yourdomain.com" className="text-blue-600 underline">
