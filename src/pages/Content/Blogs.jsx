...
const featured = {
    title: "Top 3 LinkedIn Sales Navigator Alternatives & Competitors For Sales Prospecting",
    ...
    return (
        <div className="bg-white min-h-screen flex flex-col items-center ">
            ...
            <main className="py-16 px-6 w-full small:px-0">
                <div className=" mx-auto w-[55%] small:w-[80%] flex small:flex-col justify-between gap-12">
                    <a 
                        href={featured.href}
