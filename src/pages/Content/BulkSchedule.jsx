    ...
    return (
        <div className="bg-white min-h-screen flex flex-col items-center">
            ...
            <div className="w-full xlarge:p-8 p-4">
                <section className="py-20 small:py-12 text-center px-6 bg-bluewash w-full items-center flex flex-col rounded-3xl">
                    <Navbar/>
                    <h1 
                        className="
            ...
            <main className="flex py-16 px-6 w-full small:px-0">
                <div className="mx-auto w-[55%] small:w-[80%] flex small:flex-col small:gap-12 justify-between relative">
