    ...
    return (
        <div className="bg-white min-h-screen flex flex-col items-center">
            ...
            <div className="w-full xlarge:p-8 p-4">
                <section className="py-20 text-center px-6 bg-bluewash w-full items-center flex flex-col rounded-3xl">
                    <Navbar/>
                    <h1 
                        className="
                            text-4xl font-normal w-[55%]
            ...
            <main className="flex py-16 px-6 w-full">
                <div className="mx-auto w-[55%] flex justify-between relative">
                    ...
                    <article className="flex flex-col gap-6 max-w-3xl">
                        ...
                        <p className="text-grey-300 leading-7">
                            Consistency is key when it comes to outreach. With bulk scheduling, 
                            you can plan and automate weeks of LinkedIn messages at once, ensuring 
                            you never miss an opportunity to engage with leads. Instead of manually 
                            sending messages every day, let the system work for you while you focus 
                        ...
                        <ul className="list-disc pl-5 text-grey-300 leading-7">
                            ...
                            <li>Improve productivity by focusing on conversations that convert</li>
                        </ul>

						<div className="mt-12 p-6 bg-bluewash rounded-xl border border-grey-100">
							<h3 className="text-xl font-medium text-blue-200 mb-2">💡 Final Takeaway</h3>
							<p className="text-grey-300">
								Bulk scheduling helps you scale your LinkedIn presence without the burnout. 
								Start batching your posts today and watch your productivity—and consistency—improve.
							</p>
						</div>
					...
					<div className="w-[30%] min-h-[20vh] relative">
